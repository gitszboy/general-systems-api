...
@Getter
@Entity
@Table(name = "gin_pets_sch")
class TpPetsScheduleModel (
    @Id
    @Column(name = "ptvs_code", nullable = true)
    var petSchCode: Long,

    @Column(name = "ptvs_ipu_code", nullable = true)
    var petSchIpuCode: Long? = null,
    ...
    @Column(name = "ptvs_qr_code", nullable = false)
